...
There is also a ready GitHub Actions workflow at `.github/workflows/release.yml`. If you push a tag like `v0.2.3`, it will build all release archives and attach them to the GitHub Release automatically.
